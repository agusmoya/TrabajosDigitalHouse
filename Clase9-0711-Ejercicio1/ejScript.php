...
$ceuMas = [
  "Argentina"=> ["ciudades"=>["Buenos Aires", "Córdoba", "Santa Fé"], "es_americano"=>true],
  "Brasil" => ["ciudades"=>["Brasilia", "Rio de Janeiro", "Sao Pablo"], "es_americano"=>true],
  "Colombia" => ["ciudades"=>["Cartagena", "Bogota", "Barranquilla"], "es_americano"=>true],
  ...
  <body>
      <header>
        <nav>
          ...
          foreach ($ceuMas as $pais => $matrizCiudadesBool) {
                          if ($matrizCiudadesBool["es_americano"] == true) {
                            echo "Las ciudades de $pais son:"?>
                            <ul>
                            <?php foreach ($matrizCiudadesBool["ciudades"] as $ciudades) {
                              echo "<li>$ciudades</li>";
                            } ?>
                            </ul>
                        <?php } ?>
